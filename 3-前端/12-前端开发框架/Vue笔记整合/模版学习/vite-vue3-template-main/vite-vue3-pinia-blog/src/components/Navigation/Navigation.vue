<template>
        ...
        <div class="navList">
            <ul>
                <div class="logoImg" @click="clickLogo">
                    <img src="\public\image\imgs\logo.png" alt="Impero's Blog">
                </div>
                <li>
    ...
    <div v-show="media2" class="media2">
        <div class="userHead">
            <img src="\public\image\imgs\logo.png" alt="" v-if="ifLog" @click="clickLogoPhone">
...
const NavUserInfo = defineAsyncComponent(() => import('/@/components/Navigation/NavUserInfo.vue')) //要在组件里面使用useAxios要异步引入组件
