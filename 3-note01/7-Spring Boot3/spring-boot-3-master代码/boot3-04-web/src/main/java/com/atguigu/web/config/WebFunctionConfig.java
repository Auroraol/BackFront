...
public class WebFunctionConfig {
     ...
     * 2、每个业务准备一个自己的Handlerl类
     */
    @Bean                                                                          // UserBizHandler是每个业务自己准备的Handlerl类
    public RouterFunction<ServerResponse> userRoute(UserBizHandler userBizHandler/*这个会被自动注入进来*/){
        ...
        return RouterFunctions.route() //开始定义路由信息
                .GET("/user/{id}", RequestPredicates.accept(MediaType.ALL), userBizHandler::getUser)   //{id}路径变量
