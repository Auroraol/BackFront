...
public class JwtUtil {
	...
	// SECRET ISSUSRE EXPIRE_DATE 可以把它写在Properties中, 配合com.lfj.config.Properties.JwtProperties中文件使用
	 ...
	 * @return
	 */
	public static String Token(XUser userVo) {
		//当前时间
		Date now = new Date();
		//创建过期时间
		...
		String token = JWT.create()
				...
				.withClaim("userName", userVo.getUsername())   // 存放user中的内容,UserTokenDTO中不带有敏感信息，如password字段不会出现在token中
