...
效果展示请点击：
<a href="HTML_Note.html">HTML源码，点我，复制以后存为html文件，即可访问，</a>
...
<body>
    ...
    <br/>
    <br/><b>4.分区响应图（大家可以点击任意一个app来玩一玩，很有意思吧）</b>
    <br/>
    ...
    <map name="map1">
        ...
        <area href="https://www.huya.com/" shape="circle" coords="296,188,154" target="_blank">
        <!--图片时间处点击有惊喜，老师这里有些小问题，coords的参数分别是圆心坐标x,y,和半径r-->
    </map>
