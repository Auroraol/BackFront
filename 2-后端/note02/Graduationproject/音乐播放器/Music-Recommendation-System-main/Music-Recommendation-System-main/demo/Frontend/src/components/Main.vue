	...
	<div id="user-index">
			...
			<el-container>
				<el-aside width="200px">
					...
					>
						...
						<el-menu-item route="/MyRecord" index="7">
							<i
								class="el-icon-time"
								style="padding-right:0px;"
							></i>
		...
		>
			<el-form :model="form">
				...
				<el-form-item label="最喜爱音乐类型" :label-width="formLabelWidth">
					<el-input v-model="songtype" autocomplete="off"></el-input>
				</el-form-item>
