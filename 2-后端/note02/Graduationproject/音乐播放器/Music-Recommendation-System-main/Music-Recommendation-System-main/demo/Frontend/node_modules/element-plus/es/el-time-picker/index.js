    ...
    ? (openBlock(), createBlock("div", _hoisted_1$3, [
        createVNode("div", _hoisted_2$2, [
          createVNode("div", _hoisted_3$1, [
            createVNode("div", _hoisted_4, toDisplayString(_ctx.t('el.datepicker.startTime')), 1 /* TEXT */),
            createVNode("div", {
          ...
          createVNode("div", _hoisted_5, [
            createVNode("div", _hoisted_6, toDisplayString(_ctx.t('el.datepicker.endTime')), 1 /* TEXT */),
            createVNode("div", {
              class: [{ 'has-seconds': _ctx.showSeconds, 'is-arrow': _ctx.arrowControl }, "el-time-range-picker__body el-time-panel__content"]
            }, [
              createVNode(_component_time_spinner, {
        ...
        createVNode("div", _hoisted_7, [
          ...
          createVNode("button", {
            ...
            onClick: _cache[2] || (_cache[2] = $event => (_ctx.handleConfirm()))
          }, toDisplayString(_ctx.t('el.datepicker.confirm')), 9 /* TEXT, PROPS */, ["disabled"])
        ])
      ]))
    : createCommentVNode("v-if", true)
}
...
var TimePicker = defineComponent({
    ...
    setup(props, ctx) {
        ...
        return () => h(script, Object.assign(Object.assign({ format: DEFAULT_FORMATS_TIME }, props), { type, 'onUpdate:modelValue': value => ctx.emit('update:modelValue', value) }), {
