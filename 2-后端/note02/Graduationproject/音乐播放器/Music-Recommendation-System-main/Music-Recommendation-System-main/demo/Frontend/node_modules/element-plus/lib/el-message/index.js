...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock(vue.Transition, { name: "el-message-fade" }, {
    default: vue.withCtx(() => [
      vue.withDirectives(vue.createVNode("div", {
        ...
        (_ctx.showClose)
          ? (vue.openBlock(), vue.createBlock("div", {
              ...
              onClick: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.close(...args)), ["stop"]))
            }))
          : vue.createCommentVNode("v-if", true)
...
const Message = function (opts = {}) {
    ...
    vm = vue.createVNode(script, options, util.isVNode(options.message) ? { default: () => message } : null);
