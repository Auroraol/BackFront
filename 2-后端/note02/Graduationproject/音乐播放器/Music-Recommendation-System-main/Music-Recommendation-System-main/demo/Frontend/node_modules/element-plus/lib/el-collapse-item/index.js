...
var script = vue.defineComponent({
    ...
    setup(props) {
        ...
        const collapseMitt = collapse === null || collapse === void 0 ? void 0 : collapse.collapseMitt;
        ...
        const isActive = vue.computed(() => {
            return (collapse === null || collapse === void 0 ? void 0 : collapse.activeNames.value.indexOf(props.name)) > -1;
        });
        const handleFocus = () => {
            setTimeout(() => {
                if (!isClick.value) {
        ...
        const handleHeaderClick = () => {
            if (props.disabled)
                return;
            collapseMitt === null || collapseMitt === void 0 ? void 0 : collapseMitt.emit('item-click', props.name);
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.createVNode("div", {
      ...
      vue.createVNode("div", {
        ...
        onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleHeaderClick(...args))),
        onKeyup: _cache[2] || (_cache[2] = vue.withKeys(vue.withModifiers((...args) => (_ctx.handleEnterClick(...args)), ["stop"]), ["space","enter"])),
