...
var script = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const coreWidth = vue.ref(props.width);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    onClick: _cache[3] || (_cache[3] = vue.withModifiers((...args) => (_ctx.switchValue(...args)), ["prevent"]))
  }, [
    vue.createVNode("input", {
      ...
      onKeydown: _cache[2] || (_cache[2] = vue.withKeys((...args) => (_ctx.switchValue(...args)), ["enter"]))
      ...
      ? (vue.openBlock(), vue.createBlock("span", {
          ...
          (!_ctx.inactiveIconClass && _ctx.inactiveText)
            ? (vue.openBlock(), vue.createBlock("span", {
              ...
              }, vue.toDisplayString(_ctx.inactiveText), 9 /* TEXT, PROPS */, ["aria-hidden"]))
            : vue.createCommentVNode("v-if", true)
        ], 2 /* CLASS */))
      : vue.createCommentVNode("v-if", true),
      ...
      ? (vue.openBlock(), vue.createBlock("span", {
          ...
          (!_ctx.activeIconClass && _ctx.activeText)
            ? (vue.openBlock(), vue.createBlock("span", {
                key: 1,
                "aria-hidden": !_ctx.checked
              }, vue.toDisplayString(_ctx.activeText), 9 /* TEXT, PROPS */, ["aria-hidden"]))
            : vue.createCommentVNode("v-if", true)
        ], 2 /* CLASS */))
      : vue.createCommentVNode("v-if", true)
