import { getCurrentInstance, ref, unref, computed, watch, nextTick, isRef, defineComponent, resolveComponent, openBlock, createBlock, withCtx, createVNode, Fragment, renderList, createTextVNode, toDisplayString, onBeforeMount, onMounted, onUpdated, onUnmounted, h, watchEffect, resolveDirective, renderSlot, withDirectives, createCommentVNode, vShow } from 'vue';
...
import { Mousewheel } from '../directives';
...
function createTablePopper(trigger, popperContent, popperOptions) {
    ...
    popperInstance = createPopper(trigger, content, Object.assign({ modifiers: [
            {
                name: 'offset',
                options: {
                    offset: [0, 8],
  ...
  return (openBlock(), createBlock(_component_el_popper, {
        ...
        ? (openBlock(), createBlock("div", _hoisted_1, [
            ...
            createVNode("div", _hoisted_3, [
              createVNode("button", {
                ...
                type: "",
                onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.handleConfirm(...args)))
              }, toDisplayString(_ctx.t('el.table.confirmFilter')), 11 /* TEXT, CLASS, PROPS */, ["disabled"]),
              createVNode("button", {
                type: "",
                onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.handleReset(...args)))
    ...
    trigger: withCtx(() => [
      createVNode("span", {
        ...
        onClick: _cache[5] || (_cache[5] = (...args) => (_ctx.showFilterPanel(...args)))
      }, [
        createVNode("i", {
          class: [
            'el-icon-arrow-down',
...
var TableBody = defineComponent({
    ...
    setup(props) {
        const instance = getCurrentInstance();
        const parent = instance.parent;
        const { wrappedRowRender, tooltipVisible, tooltipContent, tooltipTrigger, } = useRender(props);
...
function useStyle$2(props, layout, store, table, doLayout) {
...
var script$1 = defineComponent({
    ...
    setup(props) {
        ...
        const { setCurrentRow, toggleRowSelection, clearSelection, clearFilter, toggleAllSelection, toggleRowExpansion, clearSort, doLayout, sort, } = useUtils$1(store, layout, shouldUpdateHeight);
        const { isHidden, renderExpanded, setDragVisible, isGroup, handleMouseLeave, handleHeaderFooterMousewheel, tableSize, bodyHeight, emptyBlockStyle, handleFixedMousewheel, fixedHeight, fixedBodyHeight, resizeProxyVisible, bodyWidth, resizeState, } = useStyle$2(props, layout, store, table, doLayout);
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", {
    ...
    (_ctx.showHeader)
      ? withDirectives((openBlock(), createBlock("div", _hoisted_2$1, [
        ...
        ? (openBlock(), createBlock("div", {
            ...
            createVNode("span", _hoisted_3$1, [
              renderSlot(_ctx.$slots, "empty", {}, () => [
                createTextVNode(toDisplayString(_ctx.emptyText || _ctx.t('el.table.emptyText')), 1 /* TEXT */)
              ])
            ])
          ], 4 /* STYLE */))
        : createCommentVNode("v-if", true),
    ...
    (_ctx.showSummary)
      ? withDirectives((openBlock(), createBlock("div", _hoisted_5, [
          ...
          [vShow, _ctx.data && _ctx.data.length > 0],
          [_directive_mousewheel, _ctx.handleHeaderFooterMousewheel]
        ])
      : createCommentVNode("v-if", true),
    (_ctx.store.states.fixedColumns.value.length > 0)
      ? withDirectives((openBlock(), createBlock("div", {
        ...
        _ctx.fixedHeight,
          ...
          (_ctx.showSummary)
            ? withDirectives((openBlock(), createBlock("div", _hoisted_7, [
                createVNode(_component_table_footer, {
                  border: _ctx.border,
                  store: _ctx.store,
                  style: {
