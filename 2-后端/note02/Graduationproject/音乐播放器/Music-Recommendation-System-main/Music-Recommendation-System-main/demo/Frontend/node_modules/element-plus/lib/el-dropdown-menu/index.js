...
var script = vue.defineComponent({
    ...
    setup() {
        ...
        function hide() {
            if (elDropdown.trigger.value === 'click')
                return;
            _hide();
        }
        function _hide() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createBlock("ul", {
    ...
    onMouseenter: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.show(...args)), ["stop"])),
    onMouseleave: _cache[2] || (_cache[2] = vue.withModifiers((...args) => (_ctx.hide(...args)), ["stop"]))
  }, [
