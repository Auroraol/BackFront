...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("li", {
    ...
    onMouseenter: _cache[2] || (_cache[2] = (...args) => (_ctx.onMouseEnter(...args))),
    onFocus: _cache[3] || (_cache[3] = (...args) => (_ctx.onMouseEnter(...args))),
    onBlur: _cache[4] || (_cache[4] = (...args) => (_ctx.onMouseLeave(...args))),
    onMouseleave: _cache[5] || (_cache[5] = (...args) => (_ctx.onMouseLeave(...args)))
  }, [
    (
