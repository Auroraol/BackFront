...
var script = vue.defineComponent({
    ...
    props: Object.assign(Object.assign({}, ElCascaderPanel.CommonProps), { size: {
            type: String,
    ...
    setup(props, { emit }) {
        ...
        const checkedNodes = vue.computed(() => { var _a; return ((_a = panel.value) === null || _a === void 0 ? void 0 : _a.checkedNodes) || []; });
  ...
  return (vue.openBlock(), vue.createBlock(_component_el_popper, {
    ...
    trigger: vue.withCtx(() => [
      vue.withDirectives(vue.createVNode("div", {
        ...
        onKeydown: _cache[11] || (_cache[11] = (...args) => (_ctx.handleKeyDown(...args))),
          ...
          suffix: vue.withCtx(() => [
            (_ctx.clearBtnVisible)
              ? (vue.openBlock(), vue.createBlock("i", {
                  ...
                  onClick: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.handleClear(...args)), ["stop"]))
                }))
              : (vue.openBlock(), vue.createBlock("i", {
                  key: "arrow-down",
                  class: [
          ...
          ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [
              (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.presentTags, (tag) => {
                return (vue.openBlock(), vue.createBlock(_component_el_tag, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createVNode("span", null, vue.toDisplayString(tag.text), 1 /* TEXT */)
                  ]),
                  _: 2
              ...
              (_ctx.filterable && !_ctx.isDisabled)
                ? vue.withDirectives((vue.openBlock(), vue.createBlock("input", {
                    ...
                    onKeydown: _cache[9] || (_cache[9] = vue.withKeys((...args) => (_ctx.handleDelete(...args)), ["delete"]))
        ...
        [_directive_clickoutside, () => _ctx.togglePopperVisible(false)]
      ])
    ]),
    default: vue.withCtx(() => [
      ...
      (_ctx.filterable)
        ? vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_scrollbar, {
            key: 0,
            ref: "suggestionPanel",
            tag: "ul",
            ...
            default: vue.withCtx(() => [
              (_ctx.suggestions.length)
                ? (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 0 }, vue.renderList(_ctx.suggestions, (item) => {
              ...
              item.checked && 'is-checked'
                      ...
                      vue.createVNode("span", null, vue.toDisplayString(item.text), 1 /* TEXT */),
                      (item.checked)
                ...
                : vue.renderSlot(_ctx.$slots, "empty", { key: 1 }, () => [
                    vue.createVNode("li", _hoisted_3, vue.toDisplayString(_ctx.t('el.cascader.noMatch')), 1 /* TEXT */)
                  ])
            ]),
            _: 1
          }, 512 /* NEED_PATCH */)), [
