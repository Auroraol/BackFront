import { h, getCurrentInstance, watch, ref, watchEffect, computed, defineComponent, onBeforeMount, onMounted, onBeforeUnmount } from 'vue';
...
var ElTableColumn = defineComponent({
    ...
    render() {
        var _a, _b;
        try {
            return h('div', (_b = (_a = this.$slots).default) === null || _b === void 0 ? void 0 : _b.call(_a, {
                store: {},
                _self: {},
                column: {},
                row: {},
