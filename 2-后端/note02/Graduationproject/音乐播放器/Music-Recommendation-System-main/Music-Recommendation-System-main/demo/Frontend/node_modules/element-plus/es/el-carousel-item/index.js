import { defineComponent, getCurrentInstance, reactive, inject, computed, onMounted, toRefs, withDirectives, openBlock, createBlock, vShow, createCommentVNode, renderSlot } from 'vue';
    ...
    setup(props) {
        ...
        onMounted(() => {
            if (injectCarouselScope.updateItems) {
                injectCarouselScope.updateItems(Object.assign(Object.assign(Object.assign({ uid: instance.uid }, props), toRefs(data)), { translateItem }));
            }
        });
        return {
            data,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createBlock("div", {
    ...
    onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleItemClick(...args)))
  }, [
    (_ctx.type === 'card')
