...
interface StoreMutations {
    ...
    insertColumn: (states: StoreStates, column: AnyObject, index: number | undefined, parent: AnyObject) => void;
    removeColumn: (states: StoreStates, column: AnyObject, parent: AnyObject) => void;
...
export { TreeNode, RenderRowData, TableFooter, TableProps, WatcherPropsData, Store, Table, AnyObject, TableHeader, TableColumnCtx, TableLayout, fn, TableColumn, };
