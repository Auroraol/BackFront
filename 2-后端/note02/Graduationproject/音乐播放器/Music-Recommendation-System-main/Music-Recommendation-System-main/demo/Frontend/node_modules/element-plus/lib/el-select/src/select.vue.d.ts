...
declare const _default: import("vue").DefineComponent<{
    ...
    visible: import("vue").Ref<false> | import("vue").Ref<true>;
    softFocus: import("vue").Ref<false> | import("vue").Ref<true>;
    selectedLabel: import("vue").Ref<string>;
    hoverIndex: import("vue").Ref<number>;
    query: import("vue").Ref<string>;
    inputHovering: import("vue").Ref<false> | import("vue").Ref<true>;
    currentPlaceholder: import("vue").Ref<string>;
    menuVisibleOnFocus: import("vue").Ref<false> | import("vue").Ref<true>;
    isOnComposition: import("vue").Ref<false> | import("vue").Ref<true>;
    isSilentBlur: import("vue").Ref<false> | import("vue").Ref<true>;
