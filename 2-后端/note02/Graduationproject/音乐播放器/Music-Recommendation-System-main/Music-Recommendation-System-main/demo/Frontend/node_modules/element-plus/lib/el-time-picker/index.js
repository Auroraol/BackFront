...
var script = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const refContainer = vue.ref(null);
        ...
        const parsedValue = vue.computed(() => {
            ...
            if (valueIsEmpty.value) {
                ...
                if (Array.isArray(props.modelValue)) {
                    result = props.modelValue.map(_ => dayjs__default['default'](_));
                }
                else {
                    result = dayjs__default['default'](props.modelValue);
                }
            }
  ...
  return (vue.openBlock(), vue.createBlock(_component_el_popper, vue.mergeProps({
      ...
      (!_ctx.isRangeInput)
        ? vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_input, {
            ...
            prefix: vue.withCtx(() => [
              vue.createVNode("i", {
                ...
                onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleFocus(...args)))
              }, null, 2 /* CLASS */)
            ]),
            suffix: vue.withCtx(() => [
              vue.createVNode("i", {
                class: ["el-input__icon", [_ctx.showClose ? '' + _ctx.clearIcon : '']],
                onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.onClearIconClick(...args)))
              }, null, 2 /* CLASS */)
            ]),
            _: 1
        ...
        : vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
          ...
          _ctx.pickerVisible ? 'is-active' : ''
            ...
            onClick: _cache[10] || (_cache[10] = (...args) => (_ctx.handleFocus(...args))),
            onMouseenter: _cache[11] || (_cache[11] = (...args) => (_ctx.onMouseEnter(...args))),
            onMouseleave: _cache[12] || (_cache[12] = (...args) => (_ctx.onMouseLeave(...args))),
            onKeydown: _cache[13] || (_cache[13] = (...args) => (_ctx.handleKeydown(...args)))
          }, [
            vue.createVNode("i", {
            ...
            vue.createVNode("input", {
              ...
              onInput: _cache[3] || (_cache[3] = (...args) => (_ctx.handleStartInput(...args))),
              onChange: _cache[4] || (_cache[4] = (...args) => (_ctx.handleStartChange(...args))),
              onFocus: _cache[5] || (_cache[5] = (...args) => (_ctx.handleFocus(...args)))
            ...
            vue.createVNode("input", {
              ...
              onInput: _cache[7] || (_cache[7] = (...args) => (_ctx.handleEndInput(...args))),
              onChange: _cache[8] || (_cache[8] = (...args) => (_ctx.handleEndChange(...args)))
            }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["name", "placeholder", "value", "disabled", "readonly"]),
            vue.createVNode("i", {
              class: [[_ctx.showClose ? '' + _ctx.clearIcon : ''], "el-input__icon el-range__close-icon"],
              onClick: _cache[9] || (_cache[9] = (...args) => (_ctx.onClearIconClick(...args)))
            }, null, 2 /* CLASS */)
    ...
    default: vue.withCtx(() => [
      vue.renderSlot(_ctx.$slots, "default", vue.mergeProps({
        visible: _ctx.pickerVisible,
        "actual-visible": _ctx.pickerActualVisible,
        "parsed-value": _ctx.parsedValue,
        format: _ctx.format,
        type: _ctx.type,
        "default-value": _ctx.defaultValue
      }, _ctx.$attrs, {
        onPick: _cache[14] || (_cache[14] = (...args) => (_ctx.onPick(...args))),
        onSelectRange: _cache[15] || (_cache[15] = (...args) => (_ctx.setSelectionRange(...args))),
        onSetPickerOption: _cache[16] || (_cache[16] = (...args) => (_ctx.onSetPickerOption(...args))),
...
var script$1 = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        vue.watch(() => props.spinnerDate, adjustSpinners);
        return {
            getRefId,
            spinnerItems,
            currentScrollbar,
...
var script$2 = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const isValidValue = _date => {
            const parsedDate = dayjs__default['default'](_date);
        ...
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$2, [
            ...
            vue.createVNode("div", _hoisted_2$1, [
              vue.createVNode("button", {
                ...
                onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleCancel(...args)))
...
var script$3 = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const isValidValue = _date => {
            const parsedDate = _date.map(_ => dayjs__default['default'](_));
            const result = getRangeAvaliableTime(parsedDate);
        ...
        const parseUserInput = value => {
            ...
            if (Array.isArray(value)) {
                return value.map(_ => dayjs__default['default'](_, props.format));
            }
            return dayjs__default['default'](value, props.format);
        };
        const formatToString = value => {
        ...
        const getDefaultValue = () => {
            if (Array.isArray(defaultValue)) {
                return defaultValue.map(_ => dayjs__default['default'](_));
            }
            return [
                dayjs__default['default'](defaultValue),
                dayjs__default['default'](defaultValue).add(60, 'm'),
            ];
        };
        ctx.emit('set-picker-option', ['formatToString', formatToString]);
        ctx.emit('set-picker-option', ['parseUserInput', parseUserInput]);
...
var TimePicker = vue.defineComponent({
    name: 'ElTimePicker',
    install: null,
    props: Object.assign(Object.assign({}, defaultProps), { isRange: {
            type: Boolean,
            default: false,
        } }),
    ...
    setup(props, ctx) {
        ...
        return () => vue.h(script, Object.assign(Object.assign({ format: DEFAULT_FORMATS_TIME }, props), { type, 'onUpdate:modelValue': value => ctx.emit('update:modelValue', value) }), {
