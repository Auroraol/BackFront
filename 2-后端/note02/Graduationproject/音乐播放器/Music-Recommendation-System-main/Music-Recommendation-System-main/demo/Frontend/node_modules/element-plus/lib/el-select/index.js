...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.withDirectives((vue.openBlock(), vue.createBlock("li", {
    ...
    onClick: _cache[2] || (_cache[2] = vue.withModifiers((...args) => (_ctx.selectOptionClick(...args)), ["stop"]))
  }, [
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
    ...
    onClick: _cache[26] || (_cache[26] = vue.withModifiers((...args) => (_ctx.toggleMenu(...args)), ["stop"]))
  }, [
                ...
                (_ctx.filterable)
                  ? vue.withDirectives((vue.openBlock(), vue.createBlock("input", {
                      ...
                      onKeydown: [
                        ...
                        _cache[10] || (_cache[10] = vue.withKeys(vue.withModifiers((...args) => (_ctx.selectOption(...args)), ["stop","prevent"]), ["enter"])),
                        _cache[11] || (_cache[11] = vue.withKeys((...args) => (_ctx.deletePrevTag(...args)), ["delete"])),
        ...
        vue.createVNode(_component_el_select_menu, null, {
          default: vue.withCtx(() => [
            vue.withDirectives(vue.createVNode(_component_el_scrollbar, {
              ...
              default: vue.withCtx(() => [
                (_ctx.showNewOption)
                  ? (vue.openBlock(), vue.createBlock(_component_el_option, {
                      key: 0,
                      value: _ctx.query,
                      created: true
                    }, null, 8 /* PROPS */, ["value"]))
            ...
            (_ctx.emptyText && (!_ctx.allowCreate || _ctx.loading || (_ctx.allowCreate && _ctx.options.length === 0 )))
              ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                  (_ctx.$slots.empty)
                    ...
                    : (vue.openBlock(), vue.createBlock("p", _hoisted_4, vue.toDisplayString(_ctx.emptyText), 1 /* TEXT */))
                ], 64 /* STABLE_FRAGMENT */))
              : vue.createCommentVNode("v-if", true)
          ]),
          _: 1
