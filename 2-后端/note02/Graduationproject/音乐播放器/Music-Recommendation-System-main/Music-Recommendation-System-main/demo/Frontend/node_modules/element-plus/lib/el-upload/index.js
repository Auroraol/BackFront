...
const _hoisted_1 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-document" }, null, -1 /* HOISTED */);
...
const _hoisted_5 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-zoom-in" }, null, -1 /* HOISTED */);
const _hoisted_6 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-delete" }, null, -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(vue.TransitionGroup, {
    ...
    default: vue.withCtx(() => [
      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.files, (file, idx) => {
        return (vue.openBlock(), vue.createBlock("li", {
          ...
          onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.onFileClicked(...args)))
        }, [
          vue.renderSlot(_ctx.$slots, "default", { file: file }, () => [
            (file.status !== 'uploading' && ['picture-card', 'picture'].includes(_ctx.listType))
            ...
            vue.createVNode("a", {
              ...
              _hoisted_1,
              vue.createTextVNode(vue.toDisplayString(file.name), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"]),
            ...
            (!_ctx.disabled)
              ? (vue.openBlock(), vue.createBlock("i", _hoisted_3, vue.toDisplayString(_ctx.t('el.upload.deleteTip')), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    onDrop: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.onDrop(...args)), ["prevent"])),
    onDragover: _cache[2] || (_cache[2] = vue.withModifiers((...args) => (_ctx.onDragover(...args)), ["prevent"])),
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    onKeydown: _cache[3] || (_cache[3] = vue.withKeys(vue.withModifiers((...args) => (_ctx.handleKeydown(...args)), ["self"]), ["enter","space"]))
  }, [
    (_ctx.drag)
      ? (vue.openBlock(), vue.createBlock(_component_upload_dragger, {
          key: 0,
...
var script$3 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const { clearFiles, handleError, handleProgress, handleStart, handleSuccess, handleRemove, submit, uploadRef, uploadFiles, } = useHandlers(props);
    ...
    render() {
        ...
        const uploadComponent = vue.h(script$2, uploadData, {
            default: () => trigger === null || trigger === void 0 ? void 0 : trigger(),
        });
        return vue.h('div', [
            ...
            this.$slots.trigger
                ...
                : uploadComponent,
            (_b = (_a = this.$slots).tip) === null || _b === void 0 ? void 0 : _b.call(_a),
            this.listType !== 'picture-card' ? uploadList : null,
        ]);
    },
});
