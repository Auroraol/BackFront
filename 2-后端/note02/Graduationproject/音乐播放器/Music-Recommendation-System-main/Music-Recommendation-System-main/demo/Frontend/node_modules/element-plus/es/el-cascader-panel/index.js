...
var script = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const checkedNodeId = computed(() => { var _a; return (_a = panel.checkedNodes[0]) === null || _a === void 0 ? void 0 : _a.uid; });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("li", {
    ...
    onMouseenter: _cache[3] || (_cache[3] = (...args) => (_ctx.handleHoverExpand(...args))),
    onFocus: _cache[4] || (_cache[4] = (...args) => (_ctx.handleHoverExpand(...args))),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_el_scrollbar, {
    ...
    default: withCtx(() => [
      ...
      (_ctx.isEmpty)
        ? (openBlock(), createBlock("div", _hoisted_1$1, toDisplayString(_ctx.t('el.cascader.noData')), 1 /* TEXT */))
        : (_ctx.panel.isHoverMenu)
          ? (openBlock(), createBlock("svg", _hoisted_2$1, null, 512 /* NEED_PATCH */))
          : createCommentVNode("v-if", true)
    ]),
    _: 1
