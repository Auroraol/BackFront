...
var script = vue.defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const items = vue.ref([]);
        const offsetWidth = vue.ref(0);
        const offsetHeight = vue.ref(0);
        ...
        vue.watch(() => data.activeIndex, (current, prev) => {
...
const _hoisted_1 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-arrow-left" }, null, -1 /* HOISTED */);
const _hoisted_2 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-arrow-right" }, null, -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    onMouseenter: _cache[7] || (_cache[7] = vue.withModifiers((...args) => (_ctx.handleMouseEnter(...args)), ["stop"])),
    onMouseleave: _cache[8] || (_cache[8] = vue.withModifiers((...args) => (_ctx.handleMouseLeave(...args)), ["stop"]))
  }, [
    vue.createVNode("div", {
        ...
        ? (vue.openBlock(), vue.createBlock(vue.Transition, {
            ...
            default: vue.withCtx(() => [
              vue.withDirectives(vue.createVNode("button", {
                ...
                onMouseleave: _cache[2] || (_cache[2] = (...args) => (_ctx.handleButtonLeave(...args))),
        ...
        ? (vue.openBlock(), vue.createBlock(vue.Transition, {
            ...
            default: vue.withCtx(() => [
              vue.withDirectives(vue.createVNode("button", {
                ...
                onMouseleave: _cache[5] || (_cache[5] = (...args) => (_ctx.handleButtonLeave(...args))),
      ...
      ? (vue.openBlock(), vue.createBlock("ul", {
          ...
          { 'is-active': index === _ctx.data.activeIndex },
              ...
              vue.createVNode("button", _hoisted_3, [
                (_ctx.hasLabel)
                  ? (vue.openBlock(), vue.createBlock("span", _hoisted_4, vue.toDisplayString(item.label), 1 /* TEXT */))
                  : vue.createCommentVNode("v-if", true)
              ])
