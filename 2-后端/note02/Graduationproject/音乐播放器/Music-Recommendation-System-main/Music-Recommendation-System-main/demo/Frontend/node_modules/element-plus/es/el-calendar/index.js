...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("table", {
    ...
    (!_ctx.hideHeader)
      ? (openBlock(), createBlock("thead", _hoisted_1, [
          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.weekDays, (day) => {
            return (openBlock(), createBlock("th", { key: day }, toDisplayString(day), 1 /* TEXT */))
          }), 128 /* KEYED_FRAGMENT */))
        ]))
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", _hoisted_1$1, [
    createVNode("div", _hoisted_2$1, [
      createVNode("div", _hoisted_3, toDisplayString(_ctx.i18nDate), 1 /* TEXT */),
            ...
            createVNode(_component_el_button_group, null, {
              default: withCtx(() => [
                createVNode(_component_el_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(_ctx.t('el.datepicker.prevMonth')), 1 /* TEXT */)
                  ]),
                  _: 1
                }),
                createVNode(_component_el_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(_ctx.t('el.datepicker.today')), 1 /* TEXT */)
                  ]),
                  _: 1
                }),
                createVNode(_component_el_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(_ctx.t('el.datepicker.nextMonth')), 1 /* TEXT */)
                  ]),
                  _: 1
                })
              ]),
