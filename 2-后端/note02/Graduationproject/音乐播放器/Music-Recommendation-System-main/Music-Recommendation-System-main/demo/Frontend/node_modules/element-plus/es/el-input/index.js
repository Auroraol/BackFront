...
var script = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const textareaStyle = computed(() => (Object.assign(Object.assign({}, _textareaCalcStyle.value), { resize: props.resize })));
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", {
    ...
    onMouseenter: _cache[19] || (_cache[19] = (...args) => (_ctx.onMouseEnter(...args))),
    onMouseleave: _cache[20] || (_cache[20] = (...args) => (_ctx.onMouseLeave(...args)))
  }, [
    (_ctx.type !== 'textarea')
      ? (openBlock(), createBlock(Fragment, { key: 0 }, [
          ...
          (_ctx.type !== 'textarea')
            ? (openBlock(), createBlock("input", mergeProps({
                ...
                onCompositionstart: _cache[1] || (_cache[1] = (...args) => (_ctx.handleCompositionStart(...args))),
                onCompositionupdate: _cache[2] || (_cache[2] = (...args) => (_ctx.handleCompositionUpdate(...args))),
                onCompositionend: _cache[3] || (_cache[3] = (...args) => (_ctx.handleCompositionEnd(...args))),
                onInput: _cache[4] || (_cache[4] = (...args) => (_ctx.handleInput(...args))),
                onFocus: _cache[5] || (_cache[5] = (...args) => (_ctx.handleFocus(...args))),
                onBlur: _cache[6] || (_cache[6] = (...args) => (_ctx.handleBlur(...args))),
                onChange: _cache[7] || (_cache[7] = (...args) => (_ctx.handleChange(...args))),
                onKeydown: _cache[8] || (_cache[8] = (...args) => (_ctx.handleKeydown(...args)))
                ...
                createVNode("span", _hoisted_4, [
                  ...
                  (_ctx.showClear)
                    ? (openBlock(), createBlock("i", {
                        ...
                        onMousedown: _cache[9] || (_cache[9] = withModifiers(() => {}, ["prevent"])),
                        onClick: _cache[10] || (_cache[10] = (...args) => (_ctx.clear(...args)))
                  ...
                  (_ctx.showPwdVisible)
                    ? (openBlock(), createBlock("i", {
                        ...
                        onClick: _cache[11] || (_cache[11] = (...args) => (_ctx.handlePasswordVisible(...args)))
                      }))
                    : createCommentVNode("v-if", true),
                  (_ctx.isWordLimitVisible)
                    ? (openBlock(), createBlock("span", _hoisted_5, [
                        createVNode("span", _hoisted_6, toDisplayString(_ctx.textLength) + "/" + toDisplayString(_ctx.upperLimit), 1 /* TEXT */)
                      ]))
                    : createCommentVNode("v-if", true)
                ]),
                (_ctx.validateState)
      ...
      : (openBlock(), createBlock("textarea", mergeProps({
          ...
          "aria-label": _ctx.label,
          placeholder: _ctx.placeholder,
          onCompositionstart: _cache[12] || (_cache[12] = (...args) => (_ctx.handleCompositionStart(...args))),
          onCompositionupdate: _cache[13] || (_cache[13] = (...args) => (_ctx.handleCompositionUpdate(...args))),
          onCompositionend: _cache[14] || (_cache[14] = (...args) => (_ctx.handleCompositionEnd(...args))),
          onInput: _cache[15] || (_cache[15] = (...args) => (_ctx.handleInput(...args))),
          onFocus: _cache[16] || (_cache[16] = (...args) => (_ctx.handleFocus(...args))),
          onBlur: _cache[17] || (_cache[17] = (...args) => (_ctx.handleBlur(...args))),
          onChange: _cache[18] || (_cache[18] = (...args) => (_ctx.handleChange(...args)))
        }), null, 16 /* FULL_PROPS */, ["tabindex", "disabled", "readonly", "autocomplete", "aria-label", "placeholder"])),
    (_ctx.isWordLimitVisible && _ctx.type === 'textarea')
      ? (openBlock(), createBlock("span", _hoisted_8, toDisplayString(_ctx.textLength) + "/" + toDisplayString(_ctx.upperLimit), 1 /* TEXT */))
      : createCommentVNode("v-if", true)
