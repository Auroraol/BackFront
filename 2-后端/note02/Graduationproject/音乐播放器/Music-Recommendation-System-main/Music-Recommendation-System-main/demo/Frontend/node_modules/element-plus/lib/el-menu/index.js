...
var script$1 = vue.defineComponent({
    ...
    setup(props, ctx) {
        const openedMenus = vue.ref(props.defaultOpeneds && !props.collapse
        ...
        const openMenu = (index, indexPath) => {
            ...
            if (props.uniqueOpened) {
                openedMenus.value = openedMenus.value.filter((index) => {
                    return ((vue.isRef(indexPath) ? indexPath.value : indexPath).indexOf(index) !==
                        -1);
                });
            }
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (_ctx.props.collapseTransition)
    ? (vue.openBlock(), vue.createBlock(_component_el_menu_collapse_transition, { key: 0 }, {
        default: vue.withCtx(() => [
