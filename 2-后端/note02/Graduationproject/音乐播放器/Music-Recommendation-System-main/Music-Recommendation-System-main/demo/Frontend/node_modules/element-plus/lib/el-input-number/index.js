...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    onDragstart: _cache[5] || (_cache[5] = vue.withModifiers(() => {}, ["prevent"]))
  }, [
    (_ctx.controls)
      ? vue.withDirectives((vue.openBlock(), vue.createBlock("span", {
          ...
          role: "button",
          onKeydown: _cache[1] || (_cache[1] = vue.withKeys((...args) => (_ctx.decrease(...args)), ["enter"]))
        }, [
          vue.createVNode("i", {
    ...
    (_ctx.controls)
      ? vue.withDirectives((vue.openBlock(), vue.createBlock("span", {
          ...
          role: "button",
          onKeydown: _cache[2] || (_cache[2] = vue.withKeys((...args) => (_ctx.increase(...args)), ["enter"]))
        }, [
          vue.createVNode("i", {
