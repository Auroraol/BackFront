import { defineComponent, computed, ref, openBlock, createBlock, Transition, withCtx, withDirectives, createVNode, createCommentVNode, renderSlot, toDisplayString, Fragment, withModifiers, vShow, render as render$1, nextTick } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(Transition, { name: "el-message-fade" }, {
    default: withCtx(() => [
...
const Message = function (opts = {}) {
    ...
    vm = createVNode(script, options, isVNode(options.message) ? { default: () => message } : null);
