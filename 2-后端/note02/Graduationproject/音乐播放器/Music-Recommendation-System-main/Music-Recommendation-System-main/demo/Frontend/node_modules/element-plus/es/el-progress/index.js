import { defineComponent, computed, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, Fragment, createTextVNode } from 'vue';
    ...
    setup(props) {
        ...
        const getCurrentColor = percentage => {
            ...
            if (typeof color === 'function') {
                ...
                return (_a = colorArray[colorArray.length - 1]) === null || _a === void 0 ? void 0 : _a.color;
            }
        };
        return {
            barStyle,
          ...
          createVNode("div", {
            ...
            createVNode("div", {
              ...
              (_ctx.showText && _ctx.textInside)
                ? (openBlock(), createBlock("div", _hoisted_2, toDisplayString(_ctx.content), 1 /* TEXT */))
