...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", _hoisted_1, [
    createVNode("p", _hoisted_2, [
      createVNode(_component_el_checkbox, {
        ...
        default: withCtx(() => [
          ...
          createVNode("span", null, toDisplayString(_ctx.checkedSummary), 1 /* TEXT */)
        ]),
        _: 1
    ...
    createVNode("div", {
        ...
        ? (openBlock(), createBlock(_component_el_input, {
            ...
            prefix: withCtx(() => [
              createVNode("i", {
                ...
                onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.clearQuery(...args)))
              }, null, 2 /* CLASS */)
            ]),
            _: 1
      ...
      withDirectives(createVNode("p", { class: "el-transfer-panel__empty" }, toDisplayString(_ctx.hasNoMatch ? _ctx.t('el.transfer.noMatch') : _ctx.t('el.transfer.noData')), 513 /* TEXT, NEED_PATCH */), [
        [vShow, _ctx.hasNoMatch || _ctx.data.length === 0]
      ])
    ], 2 /* CLASS */),
    (_ctx.hasFooter)
      ? (openBlock(), createBlock("p", _hoisted_3, [
...
var script$1 = defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        return Object.assign(Object.assign({ sourceData,
            ...
            onTargetCheckedChange,
            addToLeft,
            addToRight }, toRefs(checkedState)), { hasButtonTexts,
            leftPanelTitle,
            rightPanelTitle,
...
const _hoisted_3$1 = /*#__PURE__*/createVNode("i", { class: "el-icon-arrow-left" }, null, -1 /* HOISTED */);
const _hoisted_4 = { key: 0 };
const _hoisted_5 = { key: 0 };
const _hoisted_6 = /*#__PURE__*/createVNode("i", { class: "el-icon-arrow-right" }, null, -1 /* HOISTED */);
      ...
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          ...
          (_ctx.buttonTexts[0] !== undefined)
            ? (openBlock(), createBlock("span", _hoisted_4, toDisplayString(_ctx.buttonTexts[0]), 1 /* TEXT */))
            : createCommentVNode("v-if", true)
        ]),
        _: 1
      ...
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          (_ctx.buttonTexts[1] !== undefined)
            ? (openBlock(), createBlock("span", _hoisted_5, toDisplayString(_ctx.buttonTexts[1]), 1 /* TEXT */))
            : createCommentVNode("v-if", true),
          _hoisted_6
        ]),
        _: 1
