import { defineComponent, ref, computed, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, Fragment, renderList, watch, inject, resolveComponent, resolveDirective, renderSlot, withDirectives, vShow, withCtx, createTextVNode, h } from 'vue';
import { rangeArr, TimePickPanel, extractTimeFormat, extractDateFormat, defaultProps, DEFAULT_FORMATS_DATEPICKER, DEFAULT_FORMATS_DATE, CommonPicker } from '../el-time-picker';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("table", {
    ...
    onMousemove: _cache[2] || (_cache[2] = (...args) => (_ctx.handleMouseMove(...args)))
  }, [
    createVNode("tbody", null, [
      createVNode("tr", null, [
        (_ctx.showWeekNumber)
          ? (openBlock(), createBlock("th", _hoisted_1, toDisplayString(_ctx.t('el.datepicker.week')), 1 /* TEXT */))
          : createCommentVNode("v-if", true),
        (openBlock(true), createBlock(Fragment, null, renderList(_ctx.WEEKS, (week, key) => {
          return (openBlock(), createBlock("th", { key: key }, toDisplayString(_ctx.t('el.datepicker.weeks.' + week)), 1 /* TEXT */))
        }), 128 /* KEYED_FRAGMENT */))
      ]),
          ...
          (openBlock(true), createBlock(Fragment, null, renderList(row, (cell, key_) => {
            return (openBlock(), createBlock("td", {
              ...
              createVNode("div", null, [
                createVNode("span", null, toDisplayString(cell.text), 1 /* TEXT */)
              ])
            ], 2 /* CLASS */))
          }), 128 /* KEYED_FRAGMENT */))
        ], 2 /* CLASS */))
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("table", {
    ...
    onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleMonthTableClick(...args))),
    onMousemove: _cache[2] || (_cache[2] = (...args) => (_ctx.handleMouseMove(...args)))
  }, [
    createVNode("tbody", null, [
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.rows, (row, key) => {
        return (openBlock(), createBlock("tr", { key: key }, [
          (openBlock(true), createBlock(Fragment, null, renderList(row, (cell, key_) => {
            return (openBlock(), createBlock("td", {
              key: key_,
              ...
              createVNode("div", null, [
                createVNode("a", _hoisted_1$1, toDisplayString(_ctx.t('el.datepicker.months.' + _ctx.months[cell.text])), 1 /* TEXT */)
              ])
            ], 2 /* CLASS */))
          }), 128 /* KEYED_FRAGMENT */))
        ]))
...
const _hoisted_11 = /*#__PURE__*/createVNode("td", null, null, -1 /* HOISTED */);
const _hoisted_12 = /*#__PURE__*/createVNode("td", null, null, -1 /* HOISTED */);

function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("table", {
    class: "el-year-table",
    onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.handleYearTableClick(...args)))
  }, [
    createVNode("tbody", null, [
      createVNode("tr", null, [
        createVNode("td", {
          ...
          createVNode("a", _hoisted_1$2, toDisplayString(_ctx.startYear), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 1)]
        }, [
          createVNode("a", _hoisted_2, toDisplayString(_ctx.startYear + 1), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 2)]
        }, [
          createVNode("a", _hoisted_3, toDisplayString(_ctx.startYear + 2), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 3)]
        }, [
          createVNode("a", _hoisted_4, toDisplayString(_ctx.startYear + 3), 1 /* TEXT */)
        ], 2 /* CLASS */)
      ]),
      createVNode("tr", null, [
        createVNode("td", {
          ...
          createVNode("a", _hoisted_5, toDisplayString(_ctx.startYear + 4), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 5)]
        }, [
          createVNode("a", _hoisted_6, toDisplayString(_ctx.startYear + 5), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 6)]
        }, [
          createVNode("a", _hoisted_7, toDisplayString(_ctx.startYear + 6), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 7)]
        }, [
          createVNode("a", _hoisted_8, toDisplayString(_ctx.startYear + 7), 1 /* TEXT */)
        ], 2 /* CLASS */)
      ]),
      createVNode("tr", null, [
        createVNode("td", {
          ...
          createVNode("a", _hoisted_9, toDisplayString(_ctx.startYear + 8), 1 /* TEXT */)
        ], 2 /* CLASS */),
        createVNode("td", {
          class: ["available", _ctx.getCellStyle(_ctx.startYear + 9)]
        }, [
          createVNode("a", _hoisted_10, toDisplayString(_ctx.startYear + 9), 1 /* TEXT */)
        ], 2 /* CLASS */),
        _hoisted_11,
        _hoisted_12
      ])
...
var script$3 = defineComponent({
    components: {
        DateTable: script, ElInput, ElButton, TimePickPanel, MonthTable: script$1, YearTable: script$2,
    },
  ...
  return (openBlock(), createBlock("div", {
      ...
      (_ctx.hasShortcuts)
        ? (openBlock(), createBlock("div", _hoisted_2$1, [
            (openBlock(true), createBlock(Fragment, null, renderList(_ctx.shortcuts, (shortcut, key) => {
              ...
              }, toDisplayString(shortcut.text), 9 /* TEXT, PROPS */, ["onClick"]))
            }), 128 /* KEYED_FRAGMENT */))
          ]))
        : createCommentVNode("v-if", true),
      createVNode("div", _hoisted_3$1, [
        ...
        withDirectives(createVNode("div", {
          ...
          createVNode("button", {
            ...
            onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.prevYear_(...args)))
          }, null, 8 /* PROPS */, ["aria-label"]),
          withDirectives(createVNode("button", {
            type: "button",
            "aria-label": _ctx.t(`el.datepicker.prevMonth`),
            class: "el-picker-panel__icon-btn el-date-picker__prev-btn el-icon-arrow-left",
            onClick: _cache[4] || (_cache[4] = (...args) => (_ctx.prevMonth_(...args)))
          }, null, 8 /* PROPS */, ["aria-label"]), [
          ...
          createVNode("span", {
            ...
            onClick: _cache[5] || (_cache[5] = (...args) => (_ctx.showYearPicker(...args)))
          }, toDisplayString(_ctx.yearLabel), 1 /* TEXT */),
          withDirectives(createVNode("span", {
            role: "button",
            class: ["el-date-picker__header-label", { active: _ctx.currentView === 'month' }],
            onClick: _cache[6] || (_cache[6] = (...args) => (_ctx.showMonthPicker(...args)))
          }, toDisplayString(_ctx.t(`el.datepicker.month${ _ctx.month + 1 }`)), 3 /* TEXT, CLASS */), [
            [vShow, _ctx.currentView === 'date']
          ]),
          createVNode("button", {
            type: "button",
            ...
            onClick: _cache[7] || (_cache[7] = (...args) => (_ctx.nextYear_(...args)))
          }, null, 8 /* PROPS */, ["aria-label"]),
          withDirectives(createVNode("button", {
            type: "button",
            "aria-label": _ctx.t(`el.datepicker.nextMonth`),
            class: "el-picker-panel__icon-btn el-date-picker__next-btn el-icon-arrow-right",
            onClick: _cache[8] || (_cache[8] = (...args) => (_ctx.nextMonth_(...args)))
          }, null, 8 /* PROPS */, ["aria-label"]), [
            [vShow, _ctx.currentView === 'date']
          ])
        ], 2 /* CLASS */), [
        ...
        createVNode("div", _hoisted_7$1, [
          (_ctx.currentView === 'date')
            ? (openBlock(), createBlock(_component_date_table, {
                key: 0,
          ...
          (_ctx.currentView === 'year')
            ? (openBlock(), createBlock(_component_year_table, {
                key: 1,
                date: _ctx.innerDate,
                "disabled-date": _ctx.disabledDate,
                "parsed-value": _ctx.parsedValue,
          ...
          (_ctx.currentView === 'month')
            ? (openBlock(), createBlock(_component_month_table, {
                key: 2,
                date: _ctx.innerDate,
                "parsed-value": _ctx.parsedValue,
                "disabled-date": _ctx.disabledDate,
    ...
    withDirectives(createVNode("div", _hoisted_8$1, [
      withDirectives(createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(_ctx.t('el.datepicker.now')), 1 /* TEXT */)
        ]),
        _: 1
      }, 8 /* PROPS */, ["onClick"]), [
      ...
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(_ctx.t('el.datepicker.confirm')), 1 /* TEXT */)
        ]),
        _: 1
      }, 8 /* PROPS */, ["onClick"])
    ], 512 /* NEED_PATCH */), [
...
const _hoisted_8$2 = /*#__PURE__*/createVNode("span", { class: "el-icon-arrow-right" }, null, -1 /* HOISTED */);
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", _hoisted_1$4, [
      ...
      createVNode("div", _hoisted_3$2, [
        (_ctx.showTime)
          ? (openBlock(), createBlock("div", _hoisted_4$2, [
        ...
        createVNode("div", _hoisted_12$1, [
          createVNode("div", _hoisted_13, [
            createVNode("button", {
              ...
              onClick: _cache[11] || (_cache[11] = (...args) => (_ctx.leftPrevYear(...args)))
            }),
            createVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-arrow-left",
              onClick: _cache[12] || (_cache[12] = (...args) => (_ctx.leftPrevMonth(...args)))
            }),
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  ...
                  onClick: _cache[13] || (_cache[13] = (...args) => (_ctx.leftNextYear(...args)))
            ...
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  ...
                  onClick: _cache[14] || (_cache[14] = (...args) => (_ctx.leftNextMonth(...args)))
                }, null, 10 /* CLASS, PROPS */, ["disabled"]))
              : createCommentVNode("v-if", true),
            createVNode("div", null, toDisplayString(_ctx.leftLabel), 1 /* TEXT */)
          ]),
          ...
          createVNode("div", _hoisted_15, [
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  ...
                  onClick: _cache[15] || (_cache[15] = (...args) => (_ctx.rightPrevYear(...args)))
                }, null, 10 /* CLASS, PROPS */, ["disabled"]))
              : createCommentVNode("v-if", true),
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  ...
                  onClick: _cache[16] || (_cache[16] = (...args) => (_ctx.rightPrevMonth(...args)))
                }, null, 10 /* CLASS, PROPS */, ["disabled"]))
              : createCommentVNode("v-if", true),
            createVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-d-arrow-right",
              onClick: _cache[17] || (_cache[17] = (...args) => (_ctx.rightNextYear(...args)))
            }),
            createVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-arrow-right",
              onClick: _cache[18] || (_cache[18] = (...args) => (_ctx.rightNextMonth(...args)))
            }),
            createVNode("div", null, toDisplayString(_ctx.rightLabel), 1 /* TEXT */)
          ]),
          createVNode(_component_date_table, {
            "selection-mode": "range",
            date: _ctx.rightDate,
    ...
    (_ctx.showTime)
      ? (openBlock(), createBlock("div", _hoisted_16, [
          createVNode(_component_el_button, {
            ...
            default: withCtx(() => [
              createTextVNode(toDisplayString(_ctx.t('el.datepicker.clear')), 1 /* TEXT */)
            ]),
            _: 1
          }, 8 /* PROPS */, ["onClick"]),
          createVNode(_component_el_button, {
        ...
        createVNode("div", _hoisted_4$3, [
          createVNode("div", _hoisted_5$3, [
            createVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-d-arrow-left",
              onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.leftPrevYear(...args)))
            }),
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  key: 0,
                  ...
                  disabled: !_ctx.enableYearArrow,
                  class: [{ 'is-disabled': !_ctx.enableYearArrow }, "el-picker-panel__icon-btn el-icon-d-arrow-right"],
                  onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.leftNextYear(...args)))
                }, null, 10 /* CLASS, PROPS */, ["disabled"]))
              : createCommentVNode("v-if", true),
            createVNode("div", null, toDisplayString(_ctx.leftLabel), 1 /* TEXT */)
          ]),
          ...
          createVNode("div", _hoisted_7$3, [
            (_ctx.unlinkPanels)
              ? (openBlock(), createBlock("button", {
                  ...
                  disabled: !_ctx.enableYearArrow,
                  class: [{ 'is-disabled': !_ctx.enableYearArrow }, "el-picker-panel__icon-btn el-icon-d-arrow-left"],
                  onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.rightPrevYear(...args)))
                }, null, 10 /* CLASS, PROPS */, ["disabled"]))
              : createCommentVNode("v-if", true),
            createVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-d-arrow-right",
              onClick: _cache[4] || (_cache[4] = (...args) => (_ctx.rightNextYear(...args)))
            }),
            createVNode("div", null, toDisplayString(_ctx.rightLabel), 1 /* TEXT */)
          ]),
          createVNode(_component_month_table, {
...
var DatePicker = defineComponent({
    name: 'ElDatePicker',
    install: null,
    props: Object.assign(Object.assign({}, defaultProps), { type: {
            type: String,
            default: 'date',
        } }),
    ...
    setup(props, ctx) {
        ...
        return () => h(CommonPicker, Object.assign(Object.assign({ format }, props), { type: props.type, 'onUpdate:modelValue': value => ctx.emit('update:modelValue', value) }), {
