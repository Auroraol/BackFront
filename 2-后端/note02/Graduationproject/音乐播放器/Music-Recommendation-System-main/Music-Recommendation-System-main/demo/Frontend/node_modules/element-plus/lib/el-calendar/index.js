...
var script = vue.defineComponent({
    ...
    emits: ['pick'],
    setup(props, ctx) {
        const WEEK_DAYS = vue.ref(dayjs__default['default']().localeData().weekdaysShort());
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock("table", {
    ...
    (!_ctx.hideHeader)
      ? (vue.openBlock(), vue.createBlock("thead", _hoisted_1, [
          (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.weekDays, (day) => {
            return (vue.openBlock(), vue.createBlock("th", { key: day }, vue.toDisplayString(day), 1 /* TEXT */))
          }), 128 /* KEYED_FRAGMENT */))
        ]))
...
var script$1 = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const curMonthDatePrefix = vue.computed(() => {
            return dayjs__default['default'](date.value).format('YYYY-MM');
        });
        ...
        const date = vue.computed(() => {
            if (!props.modelValue) {
                ...
                return dayjs__default['default'](props.modelValue);
            }
        });
        const validatedRange = vue.computed(() => {
            if (!props.range)
                return [];
            const rangeArrDayjs = props.range.map(_ => dayjs__default['default'](_));
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", _hoisted_1$1, [
    vue.createVNode("div", _hoisted_2$1, [
      vue.createVNode("div", _hoisted_3, vue.toDisplayString(_ctx.i18nDate), 1 /* TEXT */),
            ...
            vue.createVNode(_component_el_button_group, null, {
              default: vue.withCtx(() => [
                vue.createVNode(_component_el_button, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(_ctx.t('el.datepicker.prevMonth')), 1 /* TEXT */)
                  ]),
                  _: 1
                }),
                vue.createVNode(_component_el_button, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(_ctx.t('el.datepicker.today')), 1 /* TEXT */)
                  ]),
                  _: 1
                }),
                vue.createVNode(_component_el_button, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(_ctx.t('el.datepicker.nextMonth')), 1 /* TEXT */)
                  ]),
                  _: 1
                })
              ]),
      ...
      ? (vue.openBlock(), vue.createBlock("div", _hoisted_5, [
          vue.createVNode(_component_date_table, {
            ...
            (_ctx.$slots.dateCell)
              ...
              : undefined
          ]), 1032 /* PROPS, DYNAMIC_SLOTS */, ["date", "selected-day", "onPick"])
        ]))
          ...
          (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.validatedRange, (range_, index) => {
            return (vue.openBlock(), vue.createBlock(_component_date_table, {
              ...
              (_ctx.$slots.dateCell)
                ...
                : undefined
            ]), 1032 /* PROPS, DYNAMIC_SLOTS */, ["date", "selected-day", "range", "hide-header", "onPick"]))
          }), 128 /* KEYED_FRAGMENT */))
        ]))
  ]))
}
