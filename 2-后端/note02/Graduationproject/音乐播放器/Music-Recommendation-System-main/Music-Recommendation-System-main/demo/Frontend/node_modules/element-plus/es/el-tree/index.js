import { defineComponent, inject, h, provide, ref, getCurrentInstance, watch, nextTick, resolveComponent, withDirectives, openBlock, createBlock, withModifiers, createVNode, createCommentVNode, withCtx, Fragment, renderList, vShow, onMounted, onBeforeUnmount, onUpdated, computed, toDisplayString } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createBlock("div", {
    ...
    onClick: _cache[3] || (_cache[3] = withModifiers((...args) => (_ctx.handleClick(...args)), ["stop"])),
    onContextmenu: _cache[4] || (_cache[4] = (...args) => (_ctx.handleContextMenu(...args))),
    onDragstart: _cache[5] || (_cache[5] = withModifiers((...args) => (_ctx.handleDragStart(...args)), ["stop"])),
    onDragover: _cache[6] || (_cache[6] = withModifiers((...args) => (_ctx.handleDragOver(...args)), ["stop"])),
    onDragend: _cache[7] || (_cache[7] = withModifiers((...args) => (_ctx.handleDragEnd(...args)), ["stop"])),
    onDrop: _cache[8] || (_cache[8] = withModifiers((...args) => (_ctx.handleDrop(...args)), ["stop"]))
  }, [
    createVNode("div", {
      ...
      createVNode("span", {
        ...
        onClick: _cache[1] || (_cache[1] = withModifiers((...args) => (_ctx.handleExpandIconClick(...args)), ["stop"]))
      }, null, 2 /* CLASS */),
      (_ctx.showCheckbox)
        ? (openBlock(), createBlock(_component_el_checkbox, {
          ...
          }, null, 8 /* PROPS */, ["model-value", "indeterminate", "disabled", "onChange"]))
      ...
      }, null, 8 /* PROPS */, ["node", "render-content"])
    ], 4 /* STYLE */),
        ...
        (!_ctx.renderAfterExpand || _ctx.childNodeRendered)
          ? withDirectives((openBlock(), createBlock("div", {
              ...
              (openBlock(true), createBlock(Fragment, null, renderList(_ctx.node.childNodes, (child) => {
                ...
                }, null, 8 /* PROPS */, ["render-content", "render-after-expand", "show-checkbox", "node", "onNodeExpand"]))
              }), 128 /* KEYED_FRAGMENT */))
  ...
  ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, ["aria-expanded", "aria-disabled", "aria-checked", "draggable", "data-key"])), [
...
function useKeydown({ el$ }, store) {
    ...
    const initTabIndex = () => {
        ...
        (_a = treeItems.value[0]) === null || _a === void 0 ? void 0 : _a.setAttribute('tabindex', '0');
    };
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", {
    ...
    (openBlock(true), createBlock(Fragment, null, renderList(_ctx.root.childNodes, (child) => {
      ...
      }, null, 8 /* PROPS */, ["node", "props", "render-after-expand", "show-checkbox", "render-content", "onNodeExpand"]))
    }), 128 /* KEYED_FRAGMENT */)),
    (_ctx.isEmpty)
      ? (openBlock(), createBlock("div", _hoisted_1$1, [
          createVNode("span", _hoisted_2, toDisplayString(_ctx.emptyText), 1 /* TEXT */)
        ]))
      : createCommentVNode("v-if", true),
