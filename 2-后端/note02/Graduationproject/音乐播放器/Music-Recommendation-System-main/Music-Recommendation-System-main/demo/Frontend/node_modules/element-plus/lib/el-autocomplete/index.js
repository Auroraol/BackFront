...
const _hoisted_2 = /*#__PURE__*/vue.createVNode("i", { class: "el-icon-loading" }, null, -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(_component_el_popper, {
      ...
      vue.withDirectives(vue.createVNode("div", {
        ...
        vue.createVNode(_component_el_input, vue.mergeProps({ ref: "inputRef" }, _ctx.attrs, {
          ...
          onKeydown: [
            ...
            vue.withKeys(vue.withModifiers(_ctx.handleKeyEnter, ["prevent"]), ["enter"]),
            vue.withKeys(vue.withModifiers(_ctx.close, ["prevent"]), ["tab"])
          ]
        }), vue.createSlots({ _: 2 }, [
          (_ctx.$slots.prepend)
            ? {
        ...
        vue.createVNode(_component_el_scrollbar, {
          ...
          default: vue.withCtx(() => [
            (_ctx.suggestionLoading)
              ? (vue.openBlock(), vue.createBlock("li", _hoisted_1, [
                  _hoisted_2
                ]))
              : (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 1 }, vue.renderList(_ctx.suggestions, (item, index) => {
                  return (vue.openBlock(), vue.createBlock("li", {
                    ...
                    vue.renderSlot(_ctx.$slots, "default", { item: item }, () => [
                      vue.createTextVNode(vue.toDisplayString(item[_ctx.valueKey]), 1 /* TEXT */)
                    ])
                  ], 10 /* CLASS, PROPS */, ["id", "aria-selected", "onClick"]))
                }), 128 /* KEYED_FRAGMENT */))
          ]),
          _: 1
        })
    ...
    _: 1
  }, 8 /* PROPS */, ["visible", "placement", "popper-class", "append-to-body"]))
}
