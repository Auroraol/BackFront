...
declare const _default: import("vue").DefineComponent<{
    ...
    modelValue?: string | number | import("./types").CascaderNodePathValue | (string | number | import("./types").CascaderNodePathValue)[] | (import("./types").CascaderNodePathValue & object) | ((string | number | import("./types").CascaderNodePathValue)[] & object);
}>, {
    border: boolean;
    options: CascaderOption[];
    props: import("./types").CascaderProps;
