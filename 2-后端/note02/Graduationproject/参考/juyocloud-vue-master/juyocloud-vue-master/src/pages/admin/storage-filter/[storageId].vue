      ...
      <template #form-sub-title>
        <el-alert :closable="false" type="info">
          ...
          <div class="rules-tips">
            <b>*</b>：单级路径通配符，如表达式
            <span class="select-all code">/*.jpg</span> 可以匹配根路径下所有的 jpg
            后缀的文件
          </div>
          <div class="rules-tips">
            <b>**</b>：多级路径通配符，如表达式
            <span class="select-all code">/**.jpg</span> 可以匹配所有路径下的 jpg
            后缀的文件
          </div>
      ...
      >
        <div class="sm:flex sm:space-x-2 sm:border-b-0 sm:pb-0 border-b pb-2">
          ...
          <el-input
              ...
              placeholder="请输入表达式"
          ></el-input>
          <el-select v-model="item.mode" class="editor-input">
