/*
 * # 此文件版权属于ASO.DESIGN
 * # 文件：typeaddlogic.go  项目：aso-zero
 * # 作用：
 * # 当前修改时间：2021年07月16日 00:55:19
 * # 上次修改时间：2021年07月15日 22:53:10
 * # 作者：thunur
...
func (l *TypeAddLogic) TypeAdd(req types.TypeAddReq) (*types.Resp, error) {
	_, err := l.svcCtx.App.AppAddType(l.ctx, &appclient.AppAddTypeReq{
		Name: req.Name,
	})
	if err != nil {
