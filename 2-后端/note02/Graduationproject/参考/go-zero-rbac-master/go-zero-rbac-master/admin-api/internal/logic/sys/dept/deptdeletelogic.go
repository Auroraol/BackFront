...
func (l *DeptDeleteLogic) DeptDelete(req types.DeptDeleteReq) (*types.Resp, error) {
	_, err := l.svcCtx.Sys.DeptDelete(l.ctx, &sysclient.DeptDeleteRequest{
		Id:         req.Ids,
