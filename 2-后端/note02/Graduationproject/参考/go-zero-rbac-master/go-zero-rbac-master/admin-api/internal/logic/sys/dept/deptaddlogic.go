/*
 * # 此文件版权属于ASO.DESIGN
 * # 文件：deptaddlogic.go  项目：aso-zero
 * # 作用：
 * # 当前修改时间：2021年07月11日 02:01:58
 * # 上次修改时间：2021年07月08日 22:27:22
 * # 作者：thunur
...
func (l *DeptAddLogic) DeptAdd(req types.DeptAddReq) (*types.Resp, error) {
	_, err := l.svcCtx.Sys.DeptAdd(l.ctx, &sysclient.DeptAddRequest{
		Name:     req.Name,
