/*
 * # 此文件版权属于ASO.DESIGN
 * # 文件：gconv.go  项目：aso-zero
 * # 作用：
 * # 当前修改时间：2021年07月13日 23:45:30
 * # 上次修改时间：2021年07月13日 16:33:10
 * # 作者：thunur
...
func StructToMap(obj interface{}) map[string]interface{} {
	...
	for i := 0; i < obj1.NumField(); i++ {
		if obj1.Field(i).Tag.Get("struct") != "" {
			data[obj1.Field(i).Tag.Get("struct")] = obj2.Field(i).Interface()
		} else {
