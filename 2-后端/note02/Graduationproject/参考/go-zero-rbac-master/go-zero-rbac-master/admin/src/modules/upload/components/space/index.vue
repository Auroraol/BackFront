<template>
	<div class="cl-upload-space__wrap">
		<slot>
			<el-button v-if="showButton && !showMaterial" size="mini" @click="open">
				点击上传
			</el-button>
			<div class="grid-content bg-purple" @click="open" v-if="showMaterial">
				<i class="el-icon-folder"></i>
				<strong>文件库选择/上传</strong>
			</div>
		</slot>
