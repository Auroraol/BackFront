...
public class LeaveController {
    ...
    @ResponseBody
    public String startLeaveProcess(@RequestParam(value = "staffId") String staffId) {
    ...
    @ResponseBody
    public String applyTask(@RequestParam(value = "taskId") String taskId) {
    ...
    public void createProcessDiagramPic(HttpServletResponse httpServletResponse,@RequestParam String processId) throws Exception {
