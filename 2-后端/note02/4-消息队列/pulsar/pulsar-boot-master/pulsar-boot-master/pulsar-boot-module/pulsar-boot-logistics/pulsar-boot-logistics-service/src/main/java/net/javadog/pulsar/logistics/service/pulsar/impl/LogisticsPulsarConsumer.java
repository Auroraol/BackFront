...
@Slf4j
@Component
public class LogisticsPulsarConsumer {

    @Value("${pulsar.url}")
    private String url;
    @Value("${pulsar.logistics-topic}")
    private String topic;
    @Value("${pulsar.logistics-subscription}")
        ...
        while (true) {
            ...
            if (ObjectUtil.isNotNull(id)) {
                try {
                    ...
                    log.error("消费Pulsar物流数据异常，key【{}】，orderId【{}】：", message.getKey(), id, e);
                }
            }
