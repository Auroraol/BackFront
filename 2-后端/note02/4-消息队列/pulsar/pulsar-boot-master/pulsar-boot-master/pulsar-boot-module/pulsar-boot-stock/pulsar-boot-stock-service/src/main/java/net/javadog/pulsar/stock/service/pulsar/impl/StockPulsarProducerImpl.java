package net.javadog.pulsar.stock.service.pulsar.impl;
...
@Slf4j
@Component
public class StockPulsarProducerImpl implements StockPulsarProducer {

    @Value("${pulsar.url}")
    private String url;
    @Value("${pulsar.stock-topic}")
    ...
    public void handler(String orderId, long delay) {
        log.debug("库存成功消息至Pulsar，orderId：{}，delay：{}", orderId, delay);
        //异步发送
